        ...
        for (let loop = 0; loop < maxLoop; loop++) {
            ...
            for (let i = 0; i < cross.length; i++) {
                ...
                //checker pattern
                {
                    let fn = function (c1, c2, c3, c4, c5, c6, c34) {
                        if (c3.isnull || c4.isnull || c5.isnull || c6.isnull || c34.isnull) { return; }
                        if (c34.qnum === -1) { return; }
                    ...
                    if (!adjline.bottom.isnull) {
                        fn(adjline.top, adjline.left, adjline.bottom, adjline.right, adjline.bottom.sidecell[1].adjborder.bottom, adjline.bottom.sidecell[1].adjborder.right, adjline.bottom.sidecell[1]);
                        fn(adjline.left, adjline.top, adjline.bottom, adjline.right, adjline.bottom.sidecell[1].adjborder.bottom, adjline.bottom.sidecell[1].adjborder.right, adjline.bottom.sidecell[1]);
                        fn(adjline.top, adjline.right, adjline.bottom, adjline.left, adjline.bottom.sidecell[0].adjborder.bottom, adjline.bottom.sidecell[0].adjborder.left, adjline.bottom.sidecell[0]);
                        fn(adjline.right, adjline.top, adjline.bottom, adjline.left, adjline.bottom.sidecell[0].adjborder.bottom, adjline.bottom.sidecell[0].adjborder.left, adjline.bottom.sidecell[0]);
                    }
                    if (!adjline.top.isnull) {
                        fn(adjline.bottom, adjline.left, adjline.top, adjline.right, adjline.top.sidecell[1].adjborder.top, adjline.top.sidecell[1].adjborder.right, adjline.top.sidecell[1]);
                        fn(adjline.left, adjline.bottom, adjline.top, adjline.right, adjline.top.sidecell[1].adjborder.top, adjline.top.sidecell[1].adjborder.right, adjline.top.sidecell[1]);
                        fn(adjline.bottom, adjline.right, adjline.top, adjline.left, adjline.top.sidecell[0].adjborder.top, adjline.top.sidecell[0].adjborder.left, adjline.top.sidecell[0]);
                        fn(adjline.right, adjline.bottom, adjline.top, adjline.left, adjline.top.sidecell[0].adjborder.top, adjline.top.sidecell[0].adjborder.left, adjline.top.sidecell[0]);
                    }
                }
            }
            //avoid forming multiple loop
            ...
            for (let i = 0; i < cell.length; i++) {
                ...
                //number and color deduce
                {
                    ...
                    {
                        let fn = function (c1, c2, clue) {
                            if (!c2.isnull && c2.qsub === 0) {
                                if (clue === 1) { add_cross(c1); }
                                if (clue === 3) { add_line(c1); }
                            }
                        };
                        if ((cell[i].qnum === 1 || cell[i].qnum === 3) && innernum === 1 && outernum === 1) {
                            fn(adjline.top, adjcell.top, cell[i].qnum)
                            fn(adjline.bottom, adjcell.bottom, cell[i].qnum)
                            fn(adjline.left, adjcell.left, cell[i].qnum)
                            fn(adjline.right, adjcell.right, cell[i].qnum)
                        }
                    }
                }
                //checker pattern
